  ...
  return (
    ...
    >
      <SliderPrimitive.Track
        ...
        className="bg-secondary-background border-border relative w-full grow overflow-hidden rounded border-2 data-[orientation=horizontal]:h-3 data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-3"
      >
